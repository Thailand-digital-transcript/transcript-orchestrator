...
public class OutboxConfig {
    ...
    /**
     * Adapts the Spring Data outbox repository to the {@link OutboxEventRepository}
     * interface expected by saga-commons {@link OutboxService}. Maps between the
     * immutable saga-commons domain class {@link OutboxEvent} and the mutable JPA
     * entity {@link OutboxEventEntity}.
     */
    @Bean
    @ConditionalOnMissingBean
